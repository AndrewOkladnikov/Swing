...
public class DAO {
    ...
    public void setTableName(String lastTableName) {
        this.currentTableName = lastTableName;
    }
    ...
    public void deleteRow(String id) {
        String DELETE = "Delete from " + currentTableName + " where id=" + id;
        getTableModel(DELETE);
    }

    public void updateRow(JTable table) {
        if (Objects.equals(currentTableName, "taken_books") || table.getSelectedRow() == -1) return;
        int selectedRow = table.getSelectedRow();
        int colNum = table.getColumnCount();
        for (int i = 1; i < colNum; i++) {
            String UPDATE = "Update " + currentTableName + " Set " + table.getColumnName(i) + "= '" + table.getValueAt(selectedRow, i) +
    ...
    public void addRecord(JTable table) {
        ...
        String INSERT = "Insert into " + currentTableName + "(" + colNames + ") values(" + row + ")";
